...
// === Выбранные продукты для подтверждения на первой странице ===
  ...
  <div class="addrecord">
    ...
    <div class="pages">
      ...
      <div class="page" :style="{ transform: pageTransform }">
        ...
        <div v-if="selectedFoods.length === 0">No selected products</div>
        <FoodItemComponent
      ...
      >
        <div class="input-holder">
          ...
          <div class="bju">
            ...
            <input v-model.number="calories" type="number" placeholder="Kcal" />
          </div>
          <input
